      ...
      <div className="mx-auto bg-white h-auto pt-20 mt-12 pb-4  shadow-2xl rounded-md w-11/12">
        <div className="flex justify-between w-full p-4  ">
          ...
          <div>
            ...
            {showModal && <ProjectAdd setShowModal={setShowModal} />}
          </div>
        </div>
              ...
              <tbody>
                {projects?.map((project) => (
                  <tr key={project.id}>
                    ...
                    <td className="px-5 py-2 border-b border-gray-200 bg-white ">
                      <p className="text-black whitespace-no-wrap">{project.description}</p>
                    </td>
                    <td className="px-5 py-2 border-b border-gray-200 bg-white ">
                      <div className="flex gap-4">
                        <Tooltip title="Edit" onClick={() => [setId(project.id), setUpdateModal(true)]}>
                          <IconButton >
