...
import { usePostEducationMutation } from '../../services/EducationApi';

export const EduAdd = ({ setShowModal }) => {
  const [addEducation, { isLoading }] = usePostEducationMutation()
        ...
        <div className="relative w-4/5 sm mx-auto bg-white my-10">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            <div className="flex items-start justify-between p-2 border-b bg-light-gray border-solid border-gray-300 rounded-t ">
              <h3 className="text-3xl font-semibold bg-gradient-to-r from-fuchsia-600 via-violet-600 to-indigo-600 bg-clip-text text-transparent">Add Education</h3>
            ...
            <div className="relative p-6  flex-auto h-[500px] overflow-auto">
              <form onSubmit={handleSubmit}>
                <div className='mb-2'>
                  ...
                  <div className="mt-1">
                    <input type="text" name="degree" id='degree' onChange={e => setdegree(e.target.value)} required
                ...
                <div className='mb-2'>
                  ...
                  <div className="mt-1">
                    <input type="text" name="institute" id='institute' onChange={e => setinstitute(e.target.value)} required
                      className="px-2 py-3 mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-sky-500 sm:text-sm" />
                  </div>
                ...
                <div className="relative flex  flex-col mt-4  justify-center">
                  <button className="bg-gradient-to-r from-fuchsia-600 to-purple-600 w-max mx-auto text-white font-semibold px-10 py-2 rounded-2xl hover:shadow-sm transition-all duration-500">Add Education</button>
                </div>
              </form>
            </div>
          </div>
